...
Чтобы запустить Джанго-проект необходимо:

1) Установить зависимости:

pip install -r requirements.txt

2) Далее загружаем тестовые данные для сайта:

python manage.py loaddata db.json

3) Создаем миграции для базы данных приложения:

python manage.py migrate

4) Для запуска приложенения вводим в терминале:

python manage.py runserver

Для доступа к панели администратора нужно использовать:

а) email: admin@test.ru
б) пароль: admin
